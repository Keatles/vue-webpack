...
import { vHeader, vFooter, vNav, vWrap } from '../components'
...
export default {
  ...
  methods: {
    loadList () {
      fetch(`https://api.dribbble.com/v1/shots?access_token=9870136734b30afd5d62202f0ddeed8682a52c2dcb531ffa7dacc1b69430ece8&page=${this.current}&per_page=${this.per_page}`)
        .then((data) => data.json())
        .then((data) => {
    ...
    getHoverCardData (id, index) {
      ...
      fetch(`https://api.dribbble.com/v1/users/${id}/shots?access_token=9870136734b30afd5d62202f0ddeed8682a52c2dcb531ffa7dacc1b69430ece8`)
        .then((data) => data.json())
        .then((data) => {
          this.hover_card_data[index].shots = data
          --num === 0 && isCompleted(index)
        })
      fetch(`https://api.dribbble.com/v1/users/${id}/teams?access_token=9870136734b30afd5d62202f0ddeed8682a52c2dcb531ffa7dacc1b69430ece8`)
        .then((data) => data.json())
        .then((data) => {
      ...
      if (num === 3) {
        fetch(`${this.data[index].team.members_url}?access_token=9870136734b30afd5d62202f0ddeed8682a52c2dcb531ffa7dacc1b69430ece8`)
          .then((data) => data.json())
          .then((data) => {
